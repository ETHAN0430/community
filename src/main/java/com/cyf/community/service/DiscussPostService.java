package com.cyf.community.service;
        ...
        postListCache = Caffeine.newBuilder()
                ...
                .build(new CacheLoader<String, List<DiscussPost>>() {
                    ...
                    public @Nullable List<DiscussPost> load(@NonNull String key) throws Exception {
                        ...
                        List<DiscussPost> redisList = redisTemplate.opsForList().range(redisKey, 0, -1);
                        ...
                        List<DiscussPost> DBlist = discussPostMapper.selectDiscussPosts(0, offset, limit, 1);

                        // 存入 redis 尽量保证一致性
                        redisTemplate.opsForList().rightPushAll(redisKey, DBlist);
                        redisTemplate.expire(redisKey, 240, TimeUnit.SECONDS);
